...
public class ErrorContent {
    ...
    public static String LOGIN_USERNAME_ERROR_CODE="1009";

    public static String LOGIN_USERNAME_ERROR_MESSAGE="用户名或密码错误";

    public static String USER_NOT_LOGIN_CODE="1010";

    public static String USER_NOT_LOGIN_MESSAGE="请登录！";

    public static String FILE_UPLOAD_FAILE_CODE="1011";
